...
const SummaryCard = (props) => {
  ...
  return (
    <div className="flex justify-between items-center col-span-12 lg:col-span-7 bg-white w-full border border-opacity-5 themeShadow themeRadius px-4 xl:px-10 pt-10 pb-6 text-themeBlack relative">
      <label htmlFor="time">
      ...
      <div className="flex flex-col border-r-2 border-gray-300 pr-1 md:pr-6 py-1 sm:py-3 md:text-base mt-4">
      ...
      <div className="flex flex-col border-r-2 border-gray-300 px-1 md:px-6 py-1 sm:py-3 md:text-base mt-4">
      ...
      <div className="flex flex-col pl-1 md:pl-6 py-1 sm:py-3 md:text-base mt-4">
